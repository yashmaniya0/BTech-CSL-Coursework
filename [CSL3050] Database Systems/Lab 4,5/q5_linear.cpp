...
int main()
{
    ...
    Data R16("Ko_Ya_2418","Find_KY_2418","Kobi Yamada","Finding Muchness");
    ...
    cout << "\nTime taken to insert \"Finding Muchness by Kobi Yamada\" : " << time_taken / 1000 << " ms\n" << endl;

    start = std::chrono::high_resolution_clock::now();
    d.search(entries[2]);
    end = std::chrono::high_resolution_clock::now();
    time_taken = std::chrono::duration_cast<std::chrono::microseconds>(end - start).count();
    cout << "\nTime taken to search \"What Animals Think by Carl Safina\" : " << time_taken / 1000 << " ms\n" << endl;

    // start = std::chrono::high_resolution_clock::now();
    // string author = "Marvin Minsky";
    // cout<<"All books by Marvin Minsky :\n";
    // vector<Data*> res;
    // for(auto bucket:d.buckets){
    //     for(auto row : bucket->values){
    ...
    // end = std::chrono::high_resolution_clock::now();
    // time_taken = std::chrono::duration_cast<std::chrono::microseconds>(end - start).count();
    // cout << "\nTime taken to retrieve all books by \"Marvin Minsky\" : " << time_taken / 1000 << " ms\n" << endl;
